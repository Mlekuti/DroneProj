...
SimulationModel::SimulationModel(IController& controller)
  ...
  entityFactory.AddFactory(new HeavySnowFactory());
  entityFactory.AddFactory(new SunnyFactory());
  entityFactory.AddFactory(new TornadoFactory());
  entityFactory.AddFactory(new HeavyRainFactory());
}
